...
Hi and Welcome to the Python Fundamantals for Geoscience Repository. <br> This Repository is being constructed to make avaiable learning materials and tools for data analytics comonly found in the geoscientists toolbox.  Most of thge methodologies and workflows themselves are not new. Many geoscientists use these methods daily and have written thier own software to carry out the workflows.  However, there is very little avaiable in the public domain.<br>
...
Because I want to make the information avaiable to beginners and people who are not experieced coders I have used the JupyterLab/JupyterNotebook format. I have tried to keep the code a simples as possible. There are many ways to approach a problem and write code to carry out a calcuation so search around, ask your colleagues who use Python and try various options to fins dout what works for you. Other IDE's and code editors have differe requirements and you may want to use a differet one dependig on your needs.
